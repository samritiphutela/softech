...
const control=require('../Controller/get')
const router=express.Router()
router.get('/getdata', control.getStudentList)
router.post('/insertdata', control.getnewlist)
router.delete('/deletedata',control.getdeletelist)
router.put('/updatedata',control.getupdate)
 module.exports=router
